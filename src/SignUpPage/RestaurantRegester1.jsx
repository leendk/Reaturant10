...
export default function RestaurantRegester1() {
  ...
  const handleNext = () => {
    ...
    // الانتقال مباشرة إلى ملف آخر
    navigate('/RestaurantRegester/step2');
  };
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        fontWeight: 700,
                        fontSize: '1.1rem',
                        backgroundColor: isActive ? '#EC2323' : (isCompleted ? '#a5d6a7' : '#e0e0e0'),
                    ...
                    {index < 3 && (
                      <Box
                        sx={{
                          width: '65px',
                          height: '3px',
                          backgroundColor: isCompleted ? '#EC2323' : '#d5d5d5',
                          mx: 0
                        }}
                      />
                    )}
