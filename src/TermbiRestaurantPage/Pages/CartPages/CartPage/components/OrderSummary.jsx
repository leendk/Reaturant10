    ...
    <Box>
      ...
      >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
          ...
          <Typography sx={{ fontWeight: 600, color: '#EC2323' }}>{totalPrice}$</Typography>
        </Box>

        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
          <Typography sx={{ color: '#666' }}>Delivery</Typography>
          <Typography sx={{ fontWeight: 600, color: '#EC2323' }}>{deliveryFee}$</Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
          ...
          <Typography sx={{ fontWeight: 700, fontSize: '20px', color: '#EC2323' }}>
            {grandTotal}$
          </Typography>
        </Box>
